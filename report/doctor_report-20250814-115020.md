...
|---|---|---|---|
| ✅ PASS | **FRONT** | Manifest SourceLocation | url=https://localhost:3000/app/build-20250814-0946/taskpane.html cache_bust=no hosts=Document |
...
| ✅ PASS | **NET** | Health endpoint | 200  (2111 ms) |
| ✅ PASS | **NET** | CORS preflight | status=200 allow-origin=https://localhost:3000 (2130 ms) |
