...
| ✅ PASS | **NET** | Health endpoint | 200  (2274 ms) |
| ✅ PASS | **NET** | CORS preflight | status=200 allow-origin=https://localhost:3000 (2123 ms) |
| ✅ PASS | **API** | POST /api/analyze | http=200 inv=ok  (2163 ms) |
| ✅ PASS | **API** | Trace by CID | 200  (2108 ms) |
