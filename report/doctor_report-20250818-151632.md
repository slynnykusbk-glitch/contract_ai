...
| ✅ PASS | **NET** | Health endpoint | 200  (2134 ms) |
| ✅ PASS | **NET** | CORS preflight | status=200 allow-origin=https://localhost:3000 (2141 ms) |
| ✅ PASS | **API** | POST /api/analyze | http=200 inv=ok  (2140 ms) |
| ✅ PASS | **API** | Trace by CID | 200  (2139 ms) |
