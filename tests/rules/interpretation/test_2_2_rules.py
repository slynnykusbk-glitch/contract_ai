...
def test_time_negative():
    spec = load_rule(
        "core/rules/uk/interpretation/2_2_rules/02_time_periods_basis.yaml"
    )
...
def test_including_negative():
    spec = load_rule(
        "core/rules/uk/interpretation/2_2_rules/04_including_non_exhaustive.yaml"
    )
    t = "Including A and B."
...
def test_company_term_negative():
    spec = load_rule(
        "core/rules/uk/interpretation/2_2_rules/05_company_vs_Company.yaml"
    )
...
def test_dynamic_incorp_negative():
    spec = load_rule(
        "core/rules/uk/interpretation/2_2_rules/07_dynamic_incorp_variation.yaml"
    )
...
def test_approvals_negative():
    spec = load_rule(
        "core/rules/uk/interpretation/2_2_rules/08_approvals_writing_reps.yaml"
    )
...
def test_writing_negative():
    spec = load_rule(
        "core/rules/uk/interpretation/2_2_rules/09_writing_email_esign.yaml"
    )
...
def test_calloff_incorp_negative():
    spec = load_rule(
        "core/rules/uk/interpretation/2_2_rules/10_calloff_incorp_msa.yaml"
    )
...
def test_subcontracts_negative():
    spec = load_rule(
        "core/rules/uk/interpretation/2_2_rules/11_subcontracts_flowdown.yaml"
    )
...
def test_headings_positive():
    spec = load_rule(
        "core/rules/uk/interpretation/2_2_rules/12_headings_no_effect.yaml"
    )
...
def test_precedence_alpha_negative():
    spec = load_rule(
        "core/rules/uk/interpretation/2_2_rules/13_precedence_agreement_alpha.yaml"
    )
...
def test_precedence_calloff_negative():
    spec = load_rule(
        "core/rules/uk/interpretation/2_2_rules/14_precedence_calloff.yaml"
    )
...
def test_ambiguity_dr_negative():
    spec = load_rule(
        "core/rules/uk/interpretation/2_2_rules/15_ambiguity_dr_checks.yaml"
    )
...
def test_correlative_negative():
    spec = load_rule(
        "core/rules/uk/interpretation/2_2_rules/16_correlative_scope_creep.yaml"
    )
...
def test_stringency_negative():
    spec = load_rule(
        "core/rules/uk/interpretation/2_2_rules/17_stringency_fitness.yaml"
    )
