...
do {
  $h = curl.exe -sk https://127.0.0.1:9443/health
...
$r = curl.exe -sk --http1.1 -H "Content-Type: application/json" -H "x-api-key: local-test-key-123" -H "x-schema-version: 1.4" -X POST --data $BODY https://127.0.0.1:9443/api/analyze
...
$r2 = curl.exe -sk --http1.1 -H "Content-Type: application/json" -H "x-api-key: local-test-key-123" -H "x-schema-version: 1.4" -X POST --data $BODY2 https://127.0.0.1:9443/api/gpt-draft
...
$r3 = curl.exe -sk --http1.1 -H "Content-Type: application/json" -H "x-api-key: local-test-key-123" -H "x-schema-version: 1.4" -X POST --data $BODY3 https://127.0.0.1:9443/api/qa-recheck
